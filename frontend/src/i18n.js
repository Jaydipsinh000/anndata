...
const resources = {
  en: {
    translation: {
      ...
      "landForm": {
        "title": "Post Land Property",
        "subtitle": "List your land for rent, sale, or corporate partnership.",
        "basicSection": "Land & Location Details",
        "areaLabel": "Area in Acres",
        "locationLabel": "Village / City & District",
        "titleLabel": "Farm Title / Name (Optional)",
        "qualitySection": "Water & Soil Facilities",
        "soilLabel": "Soil Type",
        "waterLabel": "Water Source",
        "irrigationLabel": "Irrigation",
        "electricityLabel": "3-Phase Electricity Available",
        "purposeSection": "Listing Purpose & Pricing",
        "rentTab": "Rent Out",
        "sellTab": "Sell Property",
        "partnershipTab": "Partnership",
        "rentAmount": "Expected Rent Amount (₹ / Year)",
        "leaseYears": "Lease Duration (Years)",
        "totalPrice": "Total Asking Price (₹)",
        "photoUpload": "Upload Land Photo (Optional)",
        "optionalBadge": "(No photo? High quality farm image will be assigned automatically)",
        "clickUpload": "Click to Choose Farm Photos",
        "declareTitle": "Owner Self-Declaration & Mobile Verified",
        "declareBody": "I certify that I am the owner or authorized representative of this property.",
        "back": "Back",
        "next": "Next Step",
        "posting": "Posting Property...",
        "submitBtn": "Submit Property Listing",
        "successMsg": "Property posted successfully!",
        "errArea": "Please enter valid land area in acres.",
        "errLocation": "Please enter location (Village / District).",
        "errPrice": "Please enter expected price / rent amount."
      },
      "tools": {
  ...
  gu: {
    translation: {
      ...
      "landForm": {
        "title": "જમીન ની નોંધણી કરો",
        "subtitle": "ભાડે, વેચાણ અથવા કોર્પોરેટ ભાગીદારી માટે તમારી જમીન મૂકો.",
        "basicSection": "જમીન અને સરનામાની વિગત",
        "areaLabel": "કુલ વિસ્તાર (એકરમાં)",
        "locationLabel": "ગામ / શહેર અને જિલ્લો",
        "titleLabel": "ખેતરનું નામ (મરજીયાત)",
        "qualitySection": "જમીન અને પાણીની સુવિધા",
        "soilLabel": "માટીનો પ્રકાર",
        "waterLabel": "પાણીનો સ્ત્રોત",
        "irrigationLabel": "સિંચાઈ પદ્ધતિ",
        "electricityLabel": "3-ફેઝ લાઈટ જોડાણ ઉપલબ્ધ",
        "purposeSection": "ઉદ્દેશ્ય અને કિંમત",
        "rentTab": "ભાડે આપવા",
        "sellTab": "વેચવા માટે",
        "partnershipTab": "ભાગીદારી",
        "rentAmount": "અપેક્ષિત ભાડું (₹ / વર્ષ)",
        "leaseYears": "ભાડાનો સમયગાળો (વર્ષ)",
        "totalPrice": "કુલ વેચાણ કિંમત (₹)",
        "photoUpload": "ખેતરનો ફોટો અપલોડ કરો (મરજીયાત)",
        "optionalBadge": "(ફોટો નથી? સુંદર ખેતરનો ફોટો આપમેળે સેટ થઈ જશે)",
        "clickUpload": "ફોટો પસંદ કરવા અહીં ક્લિક કરો",
        "declareTitle": "માલિકીની સ્વ-જાહેરાત અને ચકાસણી",
        "declareBody": "હું પ્રમાણિત કરું છું કે હું આ જમીનનો કાયદેસરનો માલિક છું.",
        "back": "પાછળ",
        "next": "આગળ વધો",
        "posting": "જમીન સબમિટ થઈ રહી છે...",
        "submitBtn": "જમીન નોંધણી સબમિટ કરો",
        "successMsg": "જમીન સફળતાપૂર્વક નોંધાઈ ગઈ!",
        "errArea": "કૃપા કરીને એકરમાં સાચો વિસ્તાર દાખલ કરો.",
        "errLocation": "કૃપા કરીને સ્થાન (ગામ / જિલ્લો) દાખલ કરો.",
        "errPrice": "કૃપા કરીને ભાડું અથવા કિંમત દાખલ કરો."
      },
      "tools": {
        "title": "કૃષિ મશીનરી",
