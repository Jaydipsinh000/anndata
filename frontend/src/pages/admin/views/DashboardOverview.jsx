  ...
  return (
    <div className="animate-[fadeIn_0.3s_ease-out]">
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatCard title="Total Users" value={stats?.totalUsers || 0} color="border-blue-500" icon={<Users className="text-blue-500" size={24} />} />
          <StatCard title="Crop Proposals" value={stats?.totalCrops || 0} color="border-green-500" icon={<Wheat className="text-green-500" size={24} />} />
          <StatCard title="Pending Checks" value={stats?.pendingCrops || 0} color="border-orange-500" icon={<Map className="text-orange-500" size={24} />} />
          <StatCard title="Market Items" value={stats?.marketItems || 0} color="border-purple-500" icon={<Store className="text-purple-500" size={24} />} />
       </div>
